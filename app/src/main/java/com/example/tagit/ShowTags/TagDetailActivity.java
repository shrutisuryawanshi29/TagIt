    ...
    public class TagDetailActivity extends AppCompatActivity implements View.OnClickListener {
        ...
        boolean[] isColorSelectedArray = new boolean[]{false, false, false, false, false};
        String[] colorArray = new String[] {"78AD92", "A0C3D2", "78ADAC", "7893AD", "9278AD"};
        ...
        void setDyanamicStatusBarColor() {
    ...
    // finally change the color
            window.setStatusBarColor(Color.parseColor("#"+tagEventsModelArrayList.get(0).getTagColor()));
        }
        ...
        void setValuesInSelectedArray(int position) {
            isColorSelectedArray = new boolean[]{false, false, false, false, false};
